...
app.use(cors_1.default({ origin: "https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app", credentials: true }));
...
app.get('/auth/google/callback', passport_1.default.authenticate('google', { failureRedirect: 'https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app', session: true }), function (req, res) {
...
app.get('/auth/twitter/callback', passport_1.default.authenticate('twitter', { failureRedirect: 'https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app', session: true }), function (req, res) {
    res.redirect('https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app');
});
app.get('/auth/github', passport_1.default.authenticate('github'));
app.get('/auth/github/callback', passport_1.default.authenticate('github', { failureRedirect: 'https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app', session: true }), function (req, res) {
    res.redirect('https://6065a02c87bc47f3ddd64b74--awesome-goldberg-60d50e.netlify.app');
});
